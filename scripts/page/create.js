...
async function askForNesting() {
  const nestPage = await askQuestion(
    'Хотите ли вы вложить эту страницу в другую страницу? (y/n): '
  );
...
async function promptUser() {
  const route = await askQuestion(
    'Введите маршрут для новой страницы (например, about или blog/post): '
  );
